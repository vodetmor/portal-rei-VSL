...
export function Header() {
	...
	return (
		<header
			className={cn(
				'sticky top-0 z-50 mx-auto w-full max-w-6xl border-b border-transparent md:rounded-lg md:transition-all md:ease-out',
				{
					'bg-background/80 supports-[backdrop-filter]:bg-background/60 border-border backdrop-blur-xl md:top-4 md:max-w-5xl md:shadow-lg':
						scrolled && !open,
